...
public final class Move {
    ...
    static final boolean USE_ALPHABETA = false;
    static final boolean USE_NEGAMAX = true;        //if false, use regular alphabeta (if that is true), otherwise negamax instead.
